...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-005-0010-baker-s-dozen-unbounded-unicycle-track-e0699815",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-005-0010-abf580292260",
        "url": "https://www.unsolvedmath.com/problems/AMR-005-0010"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Let $\\gamma$ be a smooth arc agreeing to all orders with the $x$-axis at endpoints $(0,0)$ and $(1,0)$, and iterate $T(\\gamma)=\\gamma+\\gamma'$. Unless $\\gamma$ is a straight segment, is the resulting infinite curve unbounded in amplitude, not a graph, and not embedded?",
      "version": 1
    },
    "title": "Baker's Dozen — Unbounded unicycle tracks",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "22d0a5d8f95f47952ac803c486e53b1c9963e66ee1a795b1702d23e57d82f32c"
}
```
